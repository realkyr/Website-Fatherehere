                ...
                <div class="col-xl-6 col-xl-offset-3 col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3>Result</h3>
                            <h4>จำนวนแคลลอรี่ที่ควรกินต่อวัน(BMR) : {{$data->bmr}} กิโลแคลอรี่</h4>
                            <h4>จำนวนแคลลอรี่ที่ไม่ควรกินเกินต่อวัน(TDEE) : {{$data->calories}} กิโลแคลอรี่</h4>
                            <h4>แคลอรี่ที่รับประทาน : {{$data->food_cal}} กิโลแคลอรี่</h4>
                            <h1>{{$data->text}}</h1>
                        </div>
                    </div>
                </div>
