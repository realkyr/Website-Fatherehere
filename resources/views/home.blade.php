...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/new-responsive.css')}}" type="text/css">
    ...
    <div id="wrapper" class="clearfix" style="animation-duration: 1.5s; opacity: 1;">
        ...
        <header id="header" class="dark">
            <div id="header-wrap" class="">
                <div class="container clearfix">
                    ...
                    ============================================= -->
                    <div id="logo">
                        <a href="/" class="standard-logo"><img src="{{asset('img/logo.png')}}" alt=""></a>
                        <a href="/" class="retina-logo"><img src="{{asset('img/logo.png')}}" alt=""></a>
                    </div>
                    <!-- #logo end -->
                    <!-- Primary Navigation
                    ============================================= -->
        ...
        <!-- One Big Banner  -->
            <section class="big-banner">
                <img src="{{asset('img/big-banner-01.jpg')}}" alt="" style="width: 100%">
            </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <p class="rc-sub">"Health is the greatest gift, contentment the greatest wealth, faithfulness the best relationship."</p>
                    <p class="rc-sub">-Buddha</p>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-xs-8 col-sm-8 col-md-4 col-lg-15 col-xs-offset-2 col-md-offset-4">
                        <div class="panel"><div class="rc-stat-icon">
                            <img src="{{asset('img/git-commit-icon.svg')}}" alt="Git Commit Icon">
                        </div>
                        <div class="panel-body">
                            <h5>จำนวนผู้เข้าชม</h5>
                            <h4 class="js-countup">{{$amount}}</h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-xs-12 addspacebut col-sm-6 addspacebut col-md-6 col-lg-6">
                        <ul class="list-unstyled">
                            <li><img class="" src="{{asset('img/logobig.png')}}" /></li>
                            <li>
